...
// const db = process.env.NODE_ENV === 'test' ? 'healthligence' : 'healthligence'
...
//   connectionTimeoutMillis: 10000 // return an error after 10 second if connection not established
// })
// module.exports = pool
