...
interface IPatientService {
  save(patient: Patient): Promise<void> // eslint-disable-line no-unused-vars
  update(patient: Patient): Promise<void> // eslint-disable-line no-unused-vars
  delete(patientId: number): Promise<void> // eslint-disable-line no-unused-vars
  retrieveById(patientId: number): Promise<Patient> // eslint-disable-line no-unused-vars
